...
- [x] metadata RELEASE_MANIFEST_1.0.2.json exists
- [x] DESCRIPTION version 1.0.2
- [x] NEWS begins 1.0.2
- [x] CITATION.cff version 1.0.2
- [x] inst/CITATION version 1.0.2
- [x] Notebook 01-foundations-to-advanced-scientific-modeling.ipynb: release metadata 1.0.2
- [x] Notebook 02-data-audit-and-leakage.ipynb: release metadata 1.0.2
- [x] Notebook 03-resampling-and-scientific-design.ipynb: release metadata 1.0.2
- [x] Notebook 04-bootstrap-and-stability.ipynb: release metadata 1.0.2
- [x] Notebook 05-feature-engineering-and-selection.ipynb: release metadata 1.0.2
- [x] Notebook 06-supervised-machine-learning.ipynb: release metadata 1.0.2
- [x] Notebook 07-probabilistic-machine-learning.ipynb: release metadata 1.0.2
- [x] Notebook 08-tuning-and-scientific-benchmarking.ipynb: release metadata 1.0.2
- [x] Notebook 09-imbalance-calibration-and-thresholds.ipynb: release metadata 1.0.2
- [x] Notebook 10-explainable-ai-and-stability.ipynb: release metadata 1.0.2
- [x] Notebook 11-deep-learning-foundations.ipynb: release metadata 1.0.2
- [x] Notebook 12-deep-learning-architectures.ipynb: release metadata 1.0.2
- [x] Notebook 13-probabilistic-deep-learning.ipynb: release metadata 1.0.2
- [x] Notebook 14-deep-learning-xai-and-reproducibility.ipynb: release metadata 1.0.2
- [x] Notebook 15-bayesian-modeling.ipynb: release metadata 1.0.2
- [x] Notebook 16-bayesian-diagnostics-and-predictive-checking.ipynb: release metadata 1.0.2
- [x] Notebook 17-conformal-prediction.ipynb: release metadata 1.0.2
- [x] Notebook 18-full-uncertainty.ipynb: release metadata 1.0.2
- [x] Notebook 19-complete-scientific-workflow.ipynb: release metadata 1.0.2
- [x] Notebook 20-tracking-persistence-and-scalable-inference.ipynb: release metadata 1.0.2
- [x] Notebook 21-agronomy-soil-workflow.ipynb: release metadata 1.0.2
- [x] Notebook 22-spectroscopy-phenotyping-workflow.ipynb: release metadata 1.0.2
- [x] Notebook 23-spatial-environmental-workflow.ipynb: release metadata 1.0.2
- [x] Notebook 24-protected-external-validation.ipynb: release metadata 1.0.2
- [x] Notebook 25-api-catalog.ipynb: release metadata 1.0.2
- [x] Notebook 26-migration-and-deprecation.ipynb: release metadata 1.0.2
- [x] Notebook 27-validation-and-reproducibility.ipynb: release metadata 1.0.2
