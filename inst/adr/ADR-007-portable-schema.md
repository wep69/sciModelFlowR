...
Use JSON/YAML-compatible metadata for specs, manifests, split membership, and cross-language fixtures. Backend-native state remains separate from portable scientific metadata.
